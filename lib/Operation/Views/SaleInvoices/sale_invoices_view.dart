...
class _Sale_Invoices_viewState extends State<Sale_Invoices_view> {
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        controller.BMKID==3?'StringSale_Invoices'.tr:controller.BMKID==1?'StringPurchases_Invoices'.tr:
        controller.BMKID==4?'StringReturn_Sale_Invoices'.tr:controller.BMKID==7?'StringQuotations'.tr:
        controller.BMKID==10?'StringCustomer_Requests'.tr: controller.BMKID==12?'StringReturn_Sale_Invoices_POS'.tr:
        controller.BMKID==5?'StringService_Bills'.tr:STMID=='COU'?'StringCounterSalePosting_REP'.tr
            :'StringPOS'.tr,
