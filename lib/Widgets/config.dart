...
String SYDV_APPV= STMID=='MOB' ? '1.61' : STMID=='INVC' ? '1.22' : STMID=='EORD' ? '1.9' : '1.20';



String SYDV_APPV_APP= STMID=='MOB' ? '1.0.61' : STMID=='INVC' ? '1.0.22' : STMID=='EORD' ? '1.0.9' : '1.0.20';
String APP_V= STMID=='MOB' ? '1.0.61' :
STMID=='INVC' ? '1.0.22' :
STMID=='EORD' ? '1.0.9' :
'1.0.20';
